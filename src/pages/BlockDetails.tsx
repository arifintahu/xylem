...
export const BlockDetails = () => {
  ...
  return (
    <div className="space-y-6 animate-in fade-in slide-in-from-bottom-4 duration-500">
      ...
      {/* Transactions List */}
      <div className="bg-white dark:bg-gray-900 rounded-xl shadow-sm border border-gray-100 dark:border-gray-800 overflow-hidden transition-colors">
        <div className="p-4 border-b border-gray-100 dark:border-gray-800 bg-gray-50/50 dark:bg-gray-900/50 transition-colors">
          <h2 className="text-lg font-bold text-gray-800 dark:text-gray-100">Transactions</h2>
        </div>
        <div className="overflow-x-auto">
          <table className="w-full text-sm text-left">
             <thead className="text-xs text-gray-500 dark:text-gray-400 uppercase bg-gray-50 dark:bg-gray-800 border-b border-gray-100 dark:border-gray-800 transition-colors">
               <tr>
             ...
             <tbody className="divide-y divide-gray-100 dark:divide-gray-800">
               {block.transactions.slice(0, 50).map((tx: any) => (
                 <tr key={tx.hash} className="hover:bg-gray-50 dark:hover:bg-gray-800 transition-colors">
                   ...
                   <td className="px-6 py-4 font-mono text-gray-600 dark:text-gray-300">
                     {tx.to ? (
                        ...
                        <span className="text-gray-400 dark:text-gray-500">Contract Creation</span>
                     )}
                   </td>
                   <td className="px-6 py-4 font-mono text-gray-900 dark:text-gray-100 text-right">
               ...
               {block.transactions.length > 50 && (
                 <tr>
                   <td colSpan={4} className="px-6 py-4 text-center text-gray-500 dark:text-gray-400 text-xs">
